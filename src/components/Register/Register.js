  ...
  return (
    <form className="register" name="reg" noValidate onSubmit={handleRegister}>
      <div className="register__container">
        ...
        <input className="register__input input" id="email" type="email" placeholder="Почта" value={values.email || ""} name='email' onChange={handleInputsChange} minLength={3} maxLength={50} pattern="^[^\s@]+@([^\s@.,]+\.)+[^\s@.,]{2,}$" required />
